...
async function verifyJWS(jws) {
    const publicKeys = [
        ...
        {
            kty: "EC",
            kid: "sZ5ca2a73SgPl7aC9v4PyA4cR5zk9A6BhHX8I2CVNwM",
            use: "sig",
            alg: "ES256",
            crv: "P-256",
            x: "9B8CKA868OKjH3ydtM1jw2ax-wo0qCHP3qDR3b9jilY",
            y: "pEudYHfIMz20vz-WNZargtgDDXj6GQeN410x8u2xjQ0"
        }];
    ...
    try {
        ...
        throw new Error('JWS could not be verified by any of ' + publicKeys.length.toString() + ' keys.');
    }
    catch (err: any) {
        if (err && err.message) {
